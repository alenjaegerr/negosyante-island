    ...
    <section className="w-full px-0 pb-7 pt-1 md:pt-4">
      ...
      <div className="mt-3 flex flex-col gap-4 lg:flex-row lg:items-start lg:justify-between">
        <div className="w-full lg:max-w-[64%]">
          <div className="mb-3 inline-flex items-center rounded-full border border-[color:var(--ni-border)] bg-[var(--ni-surface-1)] px-2 py-1 text-[10px] font-bold tracking-figma-tight text-[var(--ni-text-strong)] md:text-base">
        ...
        <aside className="w-full rounded border border-[color:var(--ni-border)] bg-[var(--ni-surface-1)] px-2 py-2.5 sm:max-w-[280px] sm:p-3">

      ...
      <div className="rounded-xl border border-cyan-600/60 bg-white p-5 shadow-sm">
        <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="font-flex-bold text-2xl text-slate-900 sm:text-3xl">{business.name}</h1>
              <p className="mt-1 text-sm text-slate-600">{business.category} • {business.location}</p>
              <p className="mt-1 text-sm font-semibold text-slate-800">
                {business.verified ? "Verified Business ✅" : "Unverified Business"}
              </p>
              <p className="mt-1 text-sm font-semibold text-slate-800">{business.online ? "Online now" : "Offline"}</p>
              <p className="mt-1 text-sm text-slate-700">{business.followers.toLocaleString()} followers</p>
            </div>
          </div>
        ...
        <div className="mt-5 rounded border border-slate-200 bg-slate-50 p-3">
          <h2 className="font-reddit text-xs font-extrabold tracking-figma-tight text-slate-800">ABOUT</h2>
          <p className="mt-2 text-sm text-slate-700">{business.tagline}</p>
        </div>

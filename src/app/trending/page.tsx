      ...
      <div className="grid gap-4 md:grid-cols-2">
        {trends.map((trend) => (
          <article key={trend.id} className="rounded-xl border bg-white p-4">
            ...
            <p className="text-sm text-slate-600">Engagement: {trend.engagementPercent}%</p>
            <div className="mt-3 h-2 rounded bg-slate-200">
              <div className="h-2 rounded bg-emerald-500" style={{ width: `${Math.min(100, trend.engagementPercent)}%` }} />
            </div>
